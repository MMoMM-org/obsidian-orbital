<p align="center">
  <img src="assets/logo-orbital.png" alt="Orbital" width="400">
</p>
...
<p align="center">
  <img src="assets/orbital-relations-statusbar.png" alt="Relations tab" width="250">
  <img src="assets/orbital-dangling-source.png" alt="Dangling links tab" width="250">
  <img src="assets/orbital-recent.png" alt="Recent notes tab" width="250">
</p>

## Installation

Install **Orbital** from Obsidian's **Settings → Community plugins → Browse**, then enable it. For manual and beta (BRAT) installs, see the [installation guide](docs/installation.md).
...
Building Orbital, the test vault, and the hot-reload workflow are documented in
